...
MySQL - 10.1.38-MariaDB : Database - dental
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dental` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
CREATE TABLE `access` (
  ...
  `isPatient` tinyint(1) DEFAULT NULL,
  `isSchedule` tinyint(1) DEFAULT NULL,
  `isInspection` tinyint(1) DEFAULT NULL,
  `isTreatment` tinyint(1) DEFAULT NULL,
  `isAccess` tinyint(1) DEFAULT NULL,
  `isPayment` tinyint(1) DEFAULT NULL,
  `isReport` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(1,'hehe',1,0,0,1,0,0,NULL),
(2,'????????',1,1,1,0,NULL,0,NULL),
(3,'Doctor',1,1,1,1,1,0,0);
...
(1,123,3,'2019-05-02 00:00:00',12,'bhgui','zugere','goy','shdee'),
...
('tat2313','suuri','123','m','2019-02-06','asd',123,'ta','123123',1),
...
(1,'Battur','boldoo','1997-05-06',3,'123','123','asdassfafhfjdfetgdfxvcx',9934744,'m','ta98011719'),
(3,'Nomin','Nomin','2019-05-27',1,'Nomin','1234','',0,'f','');
